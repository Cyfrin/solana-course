...
# Task 1 - Implement [`init_pool`](https://github.com/Cyfrin/solana-course/blob/main/apps/auction/anchor/exercise/programs/amm/src/lib.rs)
- Check `fee` <= `constants::MAX_POOL_FEE`
- Check `mint_a.decimals` == `mint_b.decimals`
- Store Pool state

# Task 2 - Implement [`add_liquidity`](https://github.com/Cyfrin/solana-course/blob/main/apps/auction/anchor/exercise/programs/amm/src/lib.rs)
...
# Task 3 - Implement [`remove_liquidity`](https://github.com/Cyfrin/solana-course/blob/main/apps/auction/anchor/exercise/programs/amm/src/lib.rs)
...
# Task 4 - Implement [`swap`](https://github.com/Cyfrin/solana-course/blob/main/apps/auction/anchor/exercise/programs/amm/src/lib.rs)
